  ...
  return (
    <SectionWrapper id="contact" className="mx-auto max-w-3xl px-6 py-24 sm:py-32">
      ...
      <p className="mt-4 max-w-lg text-lg text-muted">
        Always happy to hear from founders, builders, developers, engineers, collaborators, and
        anyone curious about tech, startups, or European politics. Email is fastest.
      </p>
      ...
      <motion.a
        ...
        onClick={() =>
          sendGAEvent("event", "outbound_click", {
            link_label: "Schedule a call (CTA)",
            link_url: "https://cal.com/timbo",
            link_type: "cal",
          })
        }
