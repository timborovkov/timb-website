...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    level: 3,
    description:
      "Co-founded UpCharge (served as founding CEO) and still running Tecci with my partners. Still young at this — learning the craft of getting products to market, finding their growth loops, and running real companies. Reps over credentials.",
  ...
  },
  {
    ...
    level: 2,
    description:
      "Product- and result-driven. I take a vision or goal and turn it into something shipped — bouncing between clients, partners, engineers, and my own code to make it all work. Still growing into this one as I mature.",
...
export const BIO_SECTIONS: { heading: string; paragraphs: string[] }[] = [
  ...
  },
  {
    heading: "Companies",
    paragraphs: [
      "Tecci is the software consultancy I've been running with my partners since 2019 — we build enterprise web apps, commerce, and integrations for Nordic companies. It takes roughly 30% of my hours. I also co-founded UpCharge, Finland's leading power bank sharing network, and served as its founding CEO. I ran operations, growth, investor relations, and product, and led development of the mobile app, PWA, backend, and admin tools serving thousands of users across hundreds of venues. In early 2025 I stepped back from the active business role to go deeper on the AI wave — focusing on building new products and technologies like IRMIN, and spending a couple of months in San Francisco to see firsthand what the industry's leaders are working on and the problems they're solving. I came back more inspired and determined to build than ever.",
    ],
  },
  {
    heading: "Life",
